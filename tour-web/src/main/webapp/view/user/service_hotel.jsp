...
<html lang="vi">
    <head>
        ...
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
                    ...
                    <div class="col-md-2">
                        <ul class="list-group "><!-- affix -->
                            ...
                            <li class="list-group-item">
                                ...
                                <div class="radio ">
                                    <label><input type="radio" name="optradio" >200000-300000 </label>
                                </div>
                             </li>
                            <li class="list-group-item">
                                <h4>Stars</h4>
          ...
          <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Recommend <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="#">Most Choose</a></li>
            <li><a href="#">Best Price</a></li>
          </ul>
        </li>
        <li class="active"><a href="#">Star <span class="sr-only">(current)</span></a></li>
