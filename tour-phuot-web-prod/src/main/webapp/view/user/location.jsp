...
//                if($("#inlineCheckbox1").val() =="option1"){
//                    $("#diadiem").fadeToggle("slow");
//                }
//            });
            $("#inlineCheckbox1").click(function(){
                if($("#inlineCheckbox1").prop("checked") == true){
    ...
    <div class="row">
        <div class="col-md-10">
            <label class="checkbox-inline">
                <input type="checkbox" id="inlineCheckbox1" value="option1" checked="checked"> Place
            </label>
            <label class="checkbox-inline">
                <input type="checkbox" id="inlineCheckbox2" value="option3" checked="checked"> Food
            </label>
            <label class="checkbox-inline">
                <input type="checkbox" id="inlineCheckbox3" value="option2" checked="checked"> Hotlel
            </label>
